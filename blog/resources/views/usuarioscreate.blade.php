        ...
        <section class="content " style="width: 50em;">
            <div class="col-md-8 col-md-offset-2 col-lg-12" >
                ...
                <div class="form" >
                    ...
                    <ul class="tab-group">
                        <li class="tab active"><a href="{{route('home')}}"><- GO BACK</a></li>
                            ...
                            <form action="{{ route('user.store') }}" method="post" role="form">
                                ...
                                <div class="top-row">
                                    <div class="field-wrap">
                                        ...
                                        <input type="text" class="form-control" id="titulo" name="name" value="">
                                    </div>
                                    ...
                                    <div class="field-wrap">
                                        ...
                                        <input type="text" class="form-control" id="titulo" name="lastname" value="">
                                    </div>
                                </div>
                                <div class="top-row">
                                    <div class="field-wrap">
                                ...
                                <div class="top-row">
                                    <div class="field-wrap">
                                        ...
                                        <input type="text" class="form-control" id="titulo" name="telephone" value="">
                                    </div>




                                    <input type="hidden" class="form-control" id="titulo" name="role_id" value="3" >
                                ...
                                <button type="submit" class="button button-block"/>Add New User</button>
